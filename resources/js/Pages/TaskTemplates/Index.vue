    ...
    <div class="min-h-screen bg-gradient-to-br from-gray-50 via-gray-50 to-gray-100">
      <div class="container mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8 max-w-6xl pt-20 sm:pt-24 md:pt-28 xl:pt-8">
        <div class="mb-6 sm:mb-8 flex items-center justify-between">
          <div>
            <h1 class="text-2xl sm:text-3xl font-bold text-gray-900 mb-2">Task Templates</h1>
            <p class="text-gray-600 text-sm sm:text-base">Create reusable task templates</p>
          </div>
        ...
        <!-- Info Section -->
        <div class="bg-gradient-to-r from-blue-600/10 to-blue-600/10 rounded-xl border border-blue-200 p-4 sm:p-6 mb-6">
          <div class="flex items-start gap-4">
            ...
            <div class="flex-1">
              <h3 class="text-base sm:text-lg font-semibold text-gray-900 mb-2">What are Task Templates?</h3>
        ...
        <div v-if="templates.length === 0" class="bg-white rounded-xl border border-gray-200 shadow-sm p-12 text-center">
        ...
        <div v-else class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          <div
            ...
            :key="template.id"
            class="bg-white rounded-xl border border-gray-200 shadow-sm p-4 sm:p-6 hover:border-gray-300 transition-colors"
          >
            <div class="flex items-start justify-between mb-3">
              ...
              <div class="flex gap-2">
                <button
                  ...
                  class="p-1.5 text-gray-600 hover:text-gray-900 transition-colors"
                >
            ...
            <p class="text-sm text-gray-700 mb-2">{{ template.title }}</p>
            <p v-if="template.description" class="text-xs text-gray-500 mb-4 line-clamp-2">{{ template.description }}</p>
            ...
            <div class="flex items-center gap-2 mb-4">
              ...
              <span
                ...
                :class="template.priority === 'high' ? 'bg-red-100 text-red-600 border border-red-300'
                  : template.priority === 'medium' ? 'bg-amber-100 text-amber-600 border border-amber-300'
